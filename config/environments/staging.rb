...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "search_your_stuff_production"

  # Avoid sending real emails in staging
  ...
  config.action_mailer.default_url_options = { host: 'searchyourstuff.fyi', protocol: 'https' }
